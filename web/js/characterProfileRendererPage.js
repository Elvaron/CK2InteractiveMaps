...
window.onload = function() {
	...
	if (myCharacter.vassals.length > 0)
	{
		...
		if (characterMap.get(myChancellor).age < 20)
		{ 
			characterMap.get(myChancellor).age += 20;
		}
		...
		if (characterMap.get(myMarshal).age < 20)
		{ 
			characterMap.get(myMarshal).age += 20;
		}
		...
		if (characterMap.get(mySteward).age < 20)
		{ 
			characterMap.get(mySteward).age += 20;
		}
		...
		if (characterMap.get(mySpymaster).age < 20)
		{ 
			characterMap.get(mySpymaster).age += 20;
		}
		...
		if (characterMap.get(myChaplain).age < 20)
		{ 
			characterMap.get(myChaplain).age += 20;
		}
