function clearEvents(targetCanvas, clickerFunction, moverFunction)
{
	var c = document.getElementById(targetCanvas);
	if (clickerFunction)
	{
		c.removeEventListener('click', clickerFunction, true);
	}

	if (moverFunction)
	{
		c.removeEventListener('mousemove', moverFunction, false);
	}

	clickerFunction = null;
	moverFunction = null;
}
...
function renderCharacter(myCharacter, offset, renderStack, targetCanvas, helperCanvases)
{
	...
	clearEvents(targetCanvas, profileClicker, profileMover);
	profileMouseOverAreas = [];
	profileClickableAreas = [];
	renderStack.clear();
	...
	*/
	...
	var characterName = getFullNameWithPrimaryTitleLocation(myCharacter);
	elements[0].push( new TextLabel(offset[0] + 20, offset[1] + 30, offset[2] + 3, 500, 16, characterName, "left", "black", true, targetCanvas));
	...
	if (myCharacter.spouse > 0 && characterMap.has(myCharacter.spouse))
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 201, offset[1] + 115, offset[0] + 201 + 133, offset[1] + 115 + 133, getFullNameWithPrimaryTitleLocation(spouse)) );
		profileClickableAreas.push( new ClickableShape(offset[0] + 201, offset[1] + 115, offset[0] + 201 + 133, offset[1] + 115 + 133, "Spouse", makeCharacterRenderFunc(spouse)));
	...
	if (myCharacter.house > 0 && houses.has(myCharacter.house))
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 347, offset[1] + 78, offset[0] + 347 + 80, offset[1] + 78 + 84, "House " + houseName) );
	}
	...
	*/
	...
	profileMouseOverAreas.push( new MouseOverShape(offset[0] + 349, offset[1] + 182, offset[0] + 382, offset[1] + 215, myCharacter.dndattributes.race) );
	...
	if (isDM) {
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 394, offset[1] + 182, offset[0] + 427, offset[1] + 215, myCharacter.getAlignmentText()) );
	}
	...
	if (isDM) {
		if (myCharacter.strongholdType != strongholdType.NONE)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(offset[0] + 381, offset[1] + 322, offset[0] + 405, offset[1] + 346, myCharacter.strongholdType) );
		}
		...
		if (myCharacter.strongholdClass != classType.NONE)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(offset[0] + 410, offset[1] + 322, offset[0] + 434, offset[1] + 346, myCharacter.strongholdClass) );
		}
	}
	...
	for (var traitIterator = 0; traitIterator < myCharacter.traits.length; traitIterator++)
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(xPos, yPos, xPos + mouseOverWidth, yPos + 24, trait.getMouseOverText()) );
	}
	...
	if (myCharacter.liege > 0 && characterMap.has(myCharacter.liege))
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 231, offset[1] + 48, offset[0] + 231 + 74, offset[1] + 48 + 74, getFullNameWithPrimaryTitleLocation(liege)) );
		profileClickableAreas.push( new ClickableShape(offset[0] + 231, offset[1] + 48, offset[0] + 231 + 74, offset[1] + 48 + 74, "Liege", makeCharacterRenderFunc(liege)));
	...
	if (titleToRender > 0 && titles.has(titleToRender))
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 10, offset[1] + 88, offset[0] + 10 + 80, offset[1] + 140 + 84, getTitleMouseOverText(renderTitle)) );
		if (renderTitle.owner > 0 && characterMap.has(renderTitle.owner))
		{
			var titleOwner = characterMap.get(renderTitle.owner);
			profileClickableAreas.push( new ClickableShape(offset[0] + 10, offset[1] + 88, offset[0] + 10 + 80, offset[1] + 140 + 84, "Title Owner", makeCharacterRenderFunc(titleOwner)));
		}
	}
	...
	if (myCharacter.heir > 0 && characterMap.has(myCharacter.heir))
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 75, offset[1] + 215, offset[0] + 75 + 60, offset[1] + 215 + 60, getFullNameWithPrimaryTitleLocation(heir)) );
		profileClickableAreas.push( new ClickableShape(offset[0] + 75, offset[1] + 215, offset[0] + 75 + 60, offset[1] + 215 + 60, "Heir", makeCharacterRenderFunc(heir)));
	...
	if (myCharacter.regent > 0 && characterMap.has(myCharacter.regent))
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 158, offset[1] + 215, offset[0] + 158 + 60, offset[1] + 215 + 60, getFullNameWithPrimaryTitleLocation(regent)) );
		profileClickableAreas.push( new ClickableShape(offset[0] + 158, offset[1] + 215, offset[0] + 158 + 60, offset[1] + 215 + 60, "Regent", makeCharacterRenderFunc(regent)));
	...
	if (myCharacter.titles.length > 0)
	{
		...
		for (var titleIterator = 0; titleIterator < myCharacter.titles.length; titleIterator++)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(xPos, yPos - 20, xPos + mouseOverWidth, yPos + 51, getTitleMouseOverText(title)) );
	...
	if (myCharacter.claims.length > 0)
	{
		...
		for (var titleIterator = 0; titleIterator < myCharacter.claims.length; titleIterator++)
		{
			...
			if (title.owner > 0 && title.owner != myCharacter.id)
			{
				...
				profileClickableAreas.push( new ClickableShape(xPos, yPos - 20, xPos + mouseOverWidth, yPos + 51, "Title Owner", makeCharacterRenderFunc(titleOwner)));
			}			
		}
	}
	...
	if (myCharacter.council.exists())
	{
		...
		profileMouseOverAreas.push( new MouseOverShape(offset[0] + 344, offset[1] + 262, offset[0] + 344 + 87, offset[1] + 262 + 24, "View council") );
		//drawCouncil (council, hide, offset, mainRenderStack, targetCanvas, helperCanvases)
		profileClickableAreas.push( new ClickableShape(offset[0] + 344, offset[1] + 262, offset[0] + 344 + 87, offset[1] + 262 + 24, "Council Button", function () {
	...
	if (myCharacter.pacts.length > 0)
	{
		...
		for (var pactIterator = 0; pactIterator < myCharacter.pacts.length; pactIterator++)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(xPos, yPos, xPos + mouseOverWidth, yPos + 17 + 24, pact.getDescription()) );
			profileClickableAreas.push( new ClickableShape(xPos, yPos, xPos + mouseOverWidth, yPos + 17 + 24, "Pact Partner", makeCharacterRenderFunc(otherCharacter)));
	...
	if (myCharacter.parents.length > 0)
	{
		...
		if (fatherId > 0 && characterMap.has(fatherId))
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(xPos, yPos, xPos + 70, yPos + 70, getFullNameWithPrimaryTitleLocation(father)) );
			profileClickableAreas.push( new ClickableShape(xPos, yPos, xPos + 70, yPos + 70, "Father", makeCharacterRenderFunc(father)));
			...
			if (grandfatherId > 0 && characterMap.has(grandfatherId))
			{
				...
				profileMouseOverAreas.push( new MouseOverShape(xPos, yPos, xPos + 70, yPos + 70, getFullNameWithPrimaryTitleLocation(grandfather)) );
				profileClickableAreas.push( new ClickableShape(xPos, yPos, xPos + 70, yPos + 70, "Grandfather", makeCharacterRenderFunc(grandfather)))
			...
			if (grandmotherId > 0 && characterMap.has(grandmotherId))
			{
				...
				profileMouseOverAreas.push( new MouseOverShape(xPos, yPos, xPos + 70, yPos + 70, getFullNameWithPrimaryTitleLocation(grandmother)) );
				profileClickableAreas.push( new ClickableShape(xPos, yPos, xPos + 70, yPos + 70, "Grandmother", makeCharacterRenderFunc(grandmother)));
		...
		if (motherId > 0 && characterMap.has(motherId))
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(xPos, yPos, xPos + 70, yPos + 70, getFullNameWithPrimaryTitleLocation(mother)) );
			profileClickableAreas.push( new ClickableShape(xPos, yPos, xPos + 70, yPos + 70, "Mother", makeCharacterRenderFunc(mother)));
	...
	if (myCharacter.children.length > 0)
	{
		...
		for (var ci = 0; ci < myCharacter.children.length; ci++)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(shapeX, shapeY, maxX, maxY, getFullNameWithPrimaryTitleLocation(child)) );
			profileClickableAreas.push( new ClickableShape(shapeX, shapeY, maxX, maxY, getFullNameWithPrimaryTitleLocation(child), makeCharacterRenderFunc(child)));
	...
	if (siblings.length > 0)
	{
		...
		for (var si = 0; si < siblings.length; si++)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(shapeX, shapeY, maxX, maxY, getFullNameWithPrimaryTitleLocation(sibling)) );
			profileClickableAreas.push( new ClickableShape(shapeX, shapeY, maxX, maxY, getFullNameWithPrimaryTitleLocation(sibling), makeCharacterRenderFunc(sibling)));
			siblingIterator++;
		}
	}
	...
	if (myCharacter.vassals.length > 0)
	{
		...
		for (var vi = 0; vi < myCharacter.vassals.length; vi++)
		{
			...
			profileMouseOverAreas.push( new MouseOverShape(shapeX, shapeY, maxX, maxY, getFullNameWithPrimaryTitleLocation(vassal)) );
			profileClickableAreas.push( new ClickableShape(shapeX, shapeY, maxX, maxY, getFullNameWithPrimaryTitleLocation(vassal), makeCharacterRenderFunc(vassal)));
...
function makeCharacterRenderFunc(character)
{
	return function () { renderOwner(character.id); };
